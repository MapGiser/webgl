...
function main(){
  ...
  x_formMatrix.setRotate(45,0,0,1);
  //设置平移轴以及平移距离
  x_formMatrix.translate(0.5,0,0);
  //设置旋转角度喝旋转轴2
  //var x=x_formMatrix.rotate(-90.0,0,0,1);
  // 获取canvas元素
  ...
  //给矩阵变量赋值（之前设置的值）
  gl.uniformMatrix4fv(u_Translation,false,x_formMatrix.elements);
